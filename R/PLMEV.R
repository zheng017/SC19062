...
#' @param palabra selects the robust estimators of multivariate location and scatter
#' @param cw quantile of a chi^2, default is 0.975
#' @param k tuning constant of score function
...
#' }
#' @export
PLMEV<- function(y,vv,xt,palabra="mcd",cw=0.975,k=0.55,ventana)
{
  #-----------------------------------------------------------------
  #Local M-estimation
  #-----------------------------------------------------------------
